{# GunBroker sales from Fishbowl-only orders.
   ...
   v1 limitations: FREIGHT_REVENUE/FREIGHT_COST are NULL (data available
   for v2 via fishbowl_ship/shipcarton), COUNTRY/REGION are NULL (Fishbowl
   stores these as integer IDs, not text). #}
