with sales_order_item_allocations as (
    select
    ...
    inner join
        {{ ref('fishbowl_soitem') }} as soi -- Assuming a silver model fishbowl_soitem exists
    ...
    where
        ...
        and soi.item_type_id in (10, 12)           -- Use renamed column
)
