...
| Ingestion | Airbyte CDC on EC2 c6a.2xlarge → S3 Iceberg (Glue catalog). Legacy → Snowflake connections inactive 2026-04-07. Per-connector memory via connection `resourceRequirements`: **Magento 5 GiB** (raised from 3 GiB on 2026-07-22 after a heap-OOM spiral), **Fishbowl 2 GiB** |
