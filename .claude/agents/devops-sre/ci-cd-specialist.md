...
VALIDATION
├─ KB: .claude/kb/devops-sre/ci-cd/_______________
...
| `.claude/kb/devops-sre/ci-cd/` | DevOps patterns | Simple updates |
| `.claude/kb/devops-sre/version-control/github/` | GitHub Actions, PRs, CI/CD workflows | Not using GitHub |
...
**Sources:**
- KB: .claude/kb/devops-sre/ci-cd/patterns/{pattern}.md
