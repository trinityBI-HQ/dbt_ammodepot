...
VALIDATION
├─ KB: No dedicated testing KB exists yet. Use MCP validation as primary source.
...
| MCP (pytest docs) | Best practices validation | Simple unit tests |
...
**Sources:**
- KB: No dedicated testing KB yet — MCP used as primary source
