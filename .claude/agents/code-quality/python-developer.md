...
VALIDATION
├─ KB: No dedicated Python patterns KB exists yet. Use MCP validation as primary source.
│     Reference `.claude/kb/data-engineering/code-quality/flake8/` for Python linting standards.
...
| `.claude/kb/data-engineering/code-quality/flake8/` | Python linting standards | Not linting-related |
| MCP (Python best practices) | Pattern validation | Simple task |
...
**Sources:**
- KB: No dedicated Python patterns KB yet — reference `.claude/kb/data-engineering/code-quality/flake8/` for linting
