...
VALIDATION
├─ KB: No dedicated architecture KB exists. Reference `.claude/kb/README.md` for technology guidance.
│     Use MCP for architecture patterns.
...
| `.claude/kb/README.md` | Master KB index for finding relevant technology KBs | Already know which KB to use |
