...
def extract_invoice(image_bytes: bytes, invoice_id: str) -> Invoice:
    ...
    # Model options:
    #   gemini-2.5-flash (GA, general purpose)
    #   gemini-2.5-pro (GA, complex tasks)
    #   gemini-3-flash-preview / gemini-3-pro-preview (latest preview)
...
| 2.0.0 | 2025-01 | Initial extraction-specialist creation |
