...
kb_sources:
  - .claude/kb/ai-ml/multi-agent/crewai/       # Agent orchestration patterns
...
### Grafana KB (Metrics Dashboards)
| File | When to Load |
|------|--------------|
| `grafana/patterns/application-monitoring.md` | Pipeline metrics dashboards |
| `grafana/patterns/infrastructure-monitoring.md` | Infra health monitoring |
| `grafana/concepts/alerting.md` | Alert rules and notification policies |
| `grafana/patterns/dashboard-as-code.md` | Provisioned dashboards via Terraform/Grafonnet |
...
| 2.0.0 | 2025-01 | Initial dataops-builder creation |
