...
| `.claude/kb/cloud/aws/` | General AWS patterns (S3, IAM, CloudWatch) | Simple updates |
| `.claude/kb/cloud/aws/s3/` | S3 trigger and output patterns | No S3 involved |
| `.claude/kb/cloud/aws/iam/` | Least-privilege IAM policies | Permissions unchanged |
| `.claude/kb/cloud/aws/cloudwatch/` | Logging and monitoring patterns | Observability unchanged |
...
**KB Reference:** `.claude/kb/cloud/aws/s3/` + MCP for Lambda handler patterns
...
**KB Reference:** `.claude/kb/cloud/aws/s3/` + MCP for Parquet writer patterns
