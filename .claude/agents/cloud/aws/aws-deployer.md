...
VALIDATION
├─ KB: .claude/kb/cloud/aws/ (general) + .claude/kb/devops-sre/iac/terraform/ — use MCP for SAM/deployment-specific
...
| `.claude/kb/cloud/aws/` | General AWS patterns (S3, IAM, CloudWatch, Secrets Manager) | Simple S3 operations |
| `.claude/kb/devops-sre/iac/terraform/` | IaC patterns for infrastructure deployment | Pipeline-only task |
| `.claude/kb/cloud/aws/s3/` | S3 bucket operations and patterns | No S3 involved |
| `.claude/kb/cloud/aws/iam/` | IAM policies for deployment roles | Permissions unchanged |
| `.claude/kb/cloud/aws/cloudwatch/` | Logging and monitoring verification | No monitoring needed |
...
**KB Reference:** MCP for SAM lifecycle (no dedicated deployment KB)
...
**KB Reference:** MCP for SAM deploy commands (no dedicated deployment KB)
...
**KB Reference:** MCP for Lambda testing patterns (no dedicated deployment KB)
...
**Sources:**
- KB: .claude/kb/cloud/aws/ (general) + .claude/kb/devops-sre/iac/terraform/ — no dedicated deployment KB; use MCP for SAM-specific
