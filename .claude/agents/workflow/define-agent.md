...
(Select all that apply - browse .claude/kb/ for full list)
[ ] ai-ml/validation/pydantic - Data validation, LLM output parsing
[ ] cloud/gcp - Cloud Run, Pub/Sub, GCS, BigQuery
[ ] ai-ml/llm-platforms/gemini - Document extraction, vision tasks
[ ] ai-ml/observability/langfuse - LLM observability
[ ] devops-sre/iac/terraform or terragrunt - Infrastructure as Code
[ ] ai-ml/multi-agent/crewai - Multi-agent orchestration
[ ] ai-ml/llm-platforms/openrouter - LLM fallback provider
[ ] data-engineering/* - Dagster, dbt, Snowflake, Iceberg, etc.
[ ] devops-sre/* - Kubernetes, Docker Compose, GitHub, uv, etc.
[ ] automation/* - n8n, Mermaid
[ ] None needed"
```
...
| 1.0.0 | 2025-01 | Initial agent creation |
