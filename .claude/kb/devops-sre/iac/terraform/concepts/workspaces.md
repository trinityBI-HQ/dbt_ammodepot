...
**Empty-string workspace names rejected:** Starting in Terraform 1.13, `terraform workspace new ""` is an error. Workspace names must be non-empty strings. This prevents accidental creation of unnamed workspaces that could cause state confusion.
