...
- Setting up Langfuse v3 in a new Python project
- Adding observability to existing LLM applications
- Instrumenting Cloud Run functions or serverless workloads
- Debugging LLM call chains and agent graphs

## Implementation

```python
"""
Langfuse v3 Python SDK Integration Pattern
...
## v3 Self-Hosted Requirements

| Component | Required | Purpose |
|-----------|----------|---------|
| PostgreSQL | Yes | Transactional data |
| ClickHouse | Yes (v3) | OLAP analytics |
| Redis/Valkey | Yes (v3) | Caching, queues |
| S3/Blob Storage | Yes (v3) | Large payloads |
| Worker Container | Yes (v3) | Async processing |
