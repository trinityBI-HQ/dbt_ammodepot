...
> **Purpose**: Implement user feedback, annotation queues, and automated evaluation for LLM quality
...
- Setting up team-based annotation queues (v3)
...
Langfuse v3 introduces team-based annotation queues for structured human evaluation:

| Feature | Description |
|---------|-------------|
| Queue creation | Define queues per evaluation task (e.g., "invoice-review") |
| Assignments | Assign specific traces to team members |
| Progress tracking | Monitor labeling completion per reviewer |
| Auto-populate | Use table filters to route traces to queues |
