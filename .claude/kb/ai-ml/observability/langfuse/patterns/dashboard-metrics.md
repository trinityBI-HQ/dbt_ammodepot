...
- Leveraging v3 ClickHouse-backed analytics for fast queries
...
| Feature | Description |
|---------|-------------|
| ClickHouse analytics | Sub-second aggregations across millions of traces |
| Table filters (Nov 2025) | Filter by model, user, metadata, score, time range |
| API filters (Nov 2025) | Programmatic access to filtered analytics |
| Full-text search | Search across dataset items and trace content |
