...
> **Purpose**: Quality feedback, evaluation metrics, and annotation queues for LLM outputs
> **Confidence**: 0.95
...
Langfuse v3 adds **annotation queue assignments** for team-based labeling, allowing managers to assign specific traces to reviewers and track labeling progress across the team.
...
## Annotation Queues (v3)

| Feature | Description |
|---------|-------------|
| Queue creation | Define queues for specific evaluation tasks |
| Assignments | Assign traces to specific team members |
| Progress tracking | Monitor labeling completion per reviewer |
| Filters | Use table filters to populate queues automatically |
