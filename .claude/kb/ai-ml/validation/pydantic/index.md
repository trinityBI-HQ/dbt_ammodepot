...
> **Version**: 2.12.x (Python 3.14 support, MISSING sentinel, Pydantic AI ecosystem)
...
| **MISSING** | Sentinel value to distinguish unset vs None (v2.12, experimental) |
| **computed_field** | Decorator for derived fields included in serialization |
| **Pydantic AI** | Separate agent framework (`pydantic-ai`) for structured LLM outputs |
