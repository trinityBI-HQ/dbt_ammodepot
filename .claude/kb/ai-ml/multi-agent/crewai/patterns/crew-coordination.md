...
## Flows Alternative (v1.0+)

For event-driven coordination with branching and shared state, consider Flows (`@start`/`@listen`/`@router` decorators) instead of custom ThreadPoolExecutor logic. See [Processes and Flows](../concepts/processes.md).

## See Also

- [Crews Concept](../concepts/crews.md) | [Processes and Flows](../concepts/processes.md)
- [Triage Pattern](../patterns/triage-investigation-report.md) | [Circuit Breaker](../patterns/circuit-breaker.md)
