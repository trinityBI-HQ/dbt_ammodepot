...
## Flows Alternative (v1.8.0+)

For human-in-the-loop within Flows, use `pause_for_human_input()` instead of tool-based escalation. See [Processes and Flows](../concepts/processes.md) for details.
