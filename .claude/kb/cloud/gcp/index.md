...
| **GPU on Cloud Run** | NVIDIA L4 (GA) and RTX PRO 6000 Blackwell (Preview) GPUs |
| **Worker Pools** | Continuous background processing (Preview), third Cloud Run resource type |
| **Exactly-Once Delivery** | Pub/Sub exactly-once semantics (GA April 2025) |
| **BigQuery AI** | AI.GENERATE, AI.CLASSIFY, AI.SCORE managed SQL functions |
| **Sidecar Containers** | Multiple containers per Cloud Run instance (GA) |
| **Anywhere Cache** | SSD-backed zonal read cache for GCS (GA) |
