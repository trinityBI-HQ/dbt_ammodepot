...
| **EMRFS** | S3 as a native filesystem, replacing HDFS for persistent storage |
...
| **EMR 7.12** | Latest release: Spark 3.5.6, Iceberg 1.10.0, Hudi 1.0.2 |
...
```
                        ...
                        --------------------
                     ┌──────────────────────────┐
Data Sources         │  EMR on EC2              │     Consumers
------------         │  (managed clusters)      │     ----------
S3 (data lake) ----->│                          │---> Athena
RDS/JDBC      ----->│  EMR on EKS              │---> Redshift
Kafka/Kinesis ----->│  (virtual clusters)      │---> S3 (output)
DynamoDB      ----->│                          │---> SageMaker
                     │  EMR Serverless          │---> BI Tools
                     │  (no infrastructure)     │
                     └──────────────────────────┘
                          │         │
...
| AWS Glue | `../glue/` | Data Catalog as metastore, Glue ETL alternative |
| AWS IAM | `../iam/` | IAM roles for EMR service and EC2 profiles |
| Terraform | `../../../devops-sre/iac/terraform/` | IaC for EMR cluster provisioning |
| Dagster | `../../../data-engineering/orchestration/dagster/` | Orchestrate EMR jobs |
| Apache Iceberg | `../../../data-engineering/table-formats/iceberg/` | Table format on EMR |
