...
|--------|---------|-------------|
| **pydantic** | Data validation, LLM output parsing | `.claude/kb/ai-ml/validation/pydantic/` |
| **gcp** | Cloud Run, Pub/Sub, GCS, BigQuery | `.claude/kb/cloud/gcp/` |
| **gemini** | Document extraction, vision tasks | `.claude/kb/ai-ml/llm-platforms/gemini/` |
| **langfuse** | LLM observability | `.claude/kb/ai-ml/observability/langfuse/` |
| **terraform** | Infrastructure as Code | `.claude/kb/devops-sre/iac/terraform/` |
| **terragrunt** | Multi-environment orchestration | `.claude/kb/devops-sre/iac/terragrunt/` |
| **crewai** | Multi-agent orchestration | `.claude/kb/ai-ml/multi-agent/crewai/` |
| **openrouter** | LLM fallback provider | `.claude/kb/ai-ml/llm-platforms/openrouter/` |
...
• ai-ml/validation/       • extraction-schema       • KB/ai-ml/validation/pydantic/
• ai-ml/llm-platforms/    • invoice-extraction      • KB/ai-ml/llm-platforms/gemini/
• cloud/gcp/              • cloud-run-module        • KB/cloud/gcp/patterns/
```
...
```bash
# KB is organized: .claude/kb/{category}/{subcategory}/{domain}/
mkdir -p .claude/kb/data-engineering/transformation/dbt-core
touch .claude/kb/data-engineering/transformation/dbt-core/{index.md,quick-reference.md}
mkdir -p .claude/kb/data-engineering/transformation/dbt-core/{concepts,patterns}
```
...
domains:
  dbt-core:
    ...
    entry_point: ".claude/kb/data-engineering/transformation/dbt-core/index.md"
```
