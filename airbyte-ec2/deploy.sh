...
echo "     ONLY if free space >= the table being rewritten, and only if the table is"
echo "     actually bloated. If the weekly prune runs clean and the disk is still full,"
echo "     the data is live: cut RETENTION_DAYS or grow the volume instead."
